var ScrapsTimeout = {
    ...
    associateEvents: function(){
        ...
        YAHOO.util.Event.addListener("scrapSource", "click", function(){
            document.getElementById('scrapSource').select();
        });
        
        var me = this;
        YAHOO.util.Connect.asyncRequest('GET', "mailPage.html", {
            "success": function(resp){
                Downloadify.create('downloadify', {
                    ...
                    data: function(){
                        me.updateFlash();
                        var response = resp.responseText.replace(/__scrapSource/g, document.getElementById('scrapSource').value);
                        return response.replace(/__scrapPreview__/g, document.getElementById('scrapPreview').value);
                    },
                    onComplete: function(){
